...
<body>
        ...
        <div class="container">
            ...
            <div class="row mt-4 justify-content-center">
                <div class="col-md-6 text-center">
                    <p class="px-1">
                        Difunde PL-SEP contiene los recursos oficiales de las convocatorias para compartir en redes
    ...
    <section class="recursos">
        <div class="container">
            ...
            <div class="row mt-4">
                <div class="col-12 text-center">
                    <p><b>Nota</b>: se sugiere realizar las publicaciones durante el periodo de registro.</p>
                </div>
            </div>
            <div class="row">
                <hr class="line">
    ...
    <!-- Logos carusel -->
    <section>
        <div class="container intituciones">
            <div class="row justify-content-center">
                <div class="col-12">
                    <h4 class="endtext">Nuestras instituciones aliadas</h4>
                </div>
                <div class="col-11 col-md-12 mt-4">
                    <section class="responsive slider">
                        <div>
                            <a href="http://www.xochimilco.cdmx.gob.mx/" target="_blank"><img
                                    src="assets/img/logos/1.jpg"></a>
                        </div>
                        <div>
                        ...
                        <div>
                            <a href="https://www.conalep.edu.mx/inicio" target="_blank"><img
                                    src="assets/img/logos/7.jpg"></a>
                        </div>
                        <div>
                            <a href="https://www.milpa-alta.cdmx.gob.mx/" target="_blank"><img
                                    src="assets/img/logos/8.jpg"></a>
                        </div>
                        <div>
                            <a href="https://www.sonora.gob.mx/" target="_blank"><img src="assets/img/logos/9.jpg"></a>
                        </div>
                        <div>
                            <a href="https://radioeducacion.edu.mx/" target="_blank"><img
                                    src="assets/img/logos/10.jpg"></a>
                        </div>
                        <div>
                            <a href="https://coyoacan.cdmx.gob.mx/" target="_blank"><img
                                    src="assets/img/logos/11.jpg"></a>
                        </div>
                        <div>
                            <a href="https://www.ipn.mx/" target="_blank"><img src="assets/img/logos/12.jpg"></a>
                        </div>
                        <div>
                            <a href="https://www.salud.cdmx.gob.mx/" target="_blank"><img
                                    src="assets/img/logos/13.jpg"></a>
                        </div>
                        <div>
                            <a href="https://libros.conaliteg.gob.mx/" target="_blank"><img
                                    src="assets/img/logos/14.jpg"></a>
                        </div>
                        <div>
                            <a href="https://azcapotzalco.cdmx.gob.mx/" target="_blank"><img
                                    src="assets/img/logos/15.jpg"></a>
                        </div>
                        <div>
                            <a href="https://www.gob.mx/buengobierno" target="_blank"><img
                                    src="assets/img/logos/16.jpg"></a>
                        </div>
                        <div>
                            <a href="https://www.bajacalifornia.gob.mx/" target="_blank"><img
                                    src="assets/img/logos/17.jpg"></a>
                        </div>
                        <div>
                            <a href="https://www.gob.mx/bienestar" target="_blank"><img
                                    src="assets/img/logos/18.jpg"></a>
                        </div>
                        <div>
                            <a href="https://see.michoacan.gob.mx/" target="_blank"><img
                                    src="assets/img/logos/19.jpg"></a>
                        </div>
                        <div>
                            <a href="https://www.col.gob.mx/" target="_blank"><img src="assets/img/logos/20.jpg"></a>
                        </div>
                        <div>
                            <a href="https://educacion.nayarit.gob.mx/" target="_blank"><img
                                    src="assets/img/logos/21.jpg"></a>
                        </div>
                        <div>
                            <a href="https://www.gob.mx/sep" target="_blank"><img src="assets/img/logos/22.jpg"></a>
                        </div>
                        <div>
                            <a href="https://aguascalientes.gob.mx/index.html" target="_blank"><img
                                    src="assets/img/logos/23.jpg"></a>
                        </div>
                        <div>
                        ...
                        <div>
                            <a href="https://www.durango.gob.mx/" target="_blank"><img
                                    src="assets/img/logos/27.jpg"></a>
                        </div>
                        <div>
                            <a href="https://www.gob.mx/inea/" target="_blank"><img src="assets/img/logos/28.jpg"></a>
                        </div>
                        <div>
                            <a href="http://www.gamadero.cdmx.gob.mx/" target="_blank"><img
                                    src="assets/img/logos/29.jpg"></a>
                        </div>
                        <div>
                            <a href="https://www.gob.mx/conafe" target="_blank"><img src="assets/img/logos/30.jpg"></a>
                        </div>
                        <div>
                            <a href="http://www.iztacalco.df.gob.mx/2024/" target="_blank"><img
                                    src="assets/img/logos/31.jpg"></a>
                        </div>
                        <div>
                            <a href="https://canalonce.mx/" target="_blank"><img src="assets/img/logos/32.jpg"></a>
                        </div>
                        <div>
                            <a href="https://www.gob.mx/becasbenitojuarez" target="_blank"><img
                                    src="assets/img/logos/33.jpg"></a>
                        </div>
                        <div>
                ...
                <div class="col-12">
                    <h4>¡Juntos trabajamos para enriquecer el Sistema Educativo Nacional!</h4>
                </div>
            </div>
        </div>
    </section>
    ...
    <script>
        const buttoncopyd = document.getElementById("buttoncopyd");
        const elmcopyd = document.getElementById("copyd");
        ...
        buttoncopyd.addEventListener("click", () => {
            copyToClipboard(elmcopyd.textContent);

            var css = document.createElement("style");
            var estilo = document.createTextNode(
                "#avisotwoo {position:fixed; z-index: 9999999; top:30%;left:50%;margin-left: -40px;padding: 10px 20px; background: var(--color-primary) ;border-radius: 8px;font-size: 18px; color: #fff}"
            );
            css.appendChild(estilo);
            document.head.appendChild(css);
            var aviso = document.createElement("div");
            aviso.setAttribute("id", "avisotwoo");
            var contenidoc = document.createTextNode("Copy sugerido copiado");
            aviso.appendChild(contenidoc);
            document.body.appendChild(aviso);
            window.load = setTimeout("document.body.removeChild(avisotwoo)", 1000)
        });
    </script>

    <script>
        const buttoncopyt = document.getElementById("buttoncopyt");
        const elmcopyt = document.getElementById("copyt");
        ...
        buttoncopyt.addEventListener("click", () => {
            copyToClipboard(elmcopyt.textContent);

            var css = document.createElement("style");
            var estilo = document.createTextNode(
                "#avisotwooo {position:fixed; z-index: 9999999; top:30%;left:50%;margin-left: -40px;padding: 10px 20px; background: var(--color-primary) ;border-radius: 8px;font-size: 18px; color: #fff}"
            );
            css.appendChild(estilo);
            document.head.appendChild(css);
            var aviso = document.createElement("div");
            aviso.setAttribute("id", "avisotwooo");
            var contenidoc = document.createTextNode("Copy sugerido copiado");
            aviso.appendChild(contenidoc);
            document.body.appendChild(aviso);
            window.load = setTimeout("document.body.removeChild(avisotwooo)", 1000)
        });
    </script>
    ...
    <script>
        ...
        const driverObj = driver({
            ...
            nextBtnText: '<img src="assets/img/tour/next.png"/>',
            prevBtnText: '<img src="assets/img/tour/prev.png"/>',
