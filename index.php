...
<body>
    ...
    <div class="container">
      ...
      <div class="row mt-4 justify-content-center">
        <div class="col-md-9 text-center">
          <p class="px-1">
            Prepa en Línea-SEP es un servicio gratuito de bachillerato en línea, dirigido a población mexicana con certificado de secundaria y a población extranjera con estancia legal en México, sin importar la edad ni el lugar de residencia.
          </p>
        </div>
      </div>
    ...
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-12 mb-4">
          <h2>Sigue tu proceso</h2>
        </div>
        <div class="col-md-10">
          <p class="text-center">El ingreso a Prepa en Línea-SEP se realiza en varios pasos. Si te inscribiste en alguna de las siguientes generaciones, revisa las fechas y enlaces correspondientes para dar seguimiento y completar tu proceso.</p>
        </div>
      </div>
      <div class="row justify-content-center">
        ...
        <div class="col-md-3 text-center">
          ...
          <p>
            <a type="button" data-bs-toggle="modal" data-bs-target="#guiaAspiranteB" class="btn-detalle">
              <svg width="18" height="22" class="me-2">
                <use xlink:href="./assets/img/sprite.svg#icono-guiar"></use>
              </svg>Guía del aspirante
            </a>
        ...
        <div class="col-md-3 text-center">
          ...
          <p>
            <a type="button" data-bs-toggle="modal" data-bs-target="#guiaAspiranteC" class="btn-detalle">
              <svg width="18" height="22" class="me-2">
                <use xlink:href="./assets/img/sprite.svg#icono-guiar"></use>
              </svg>Guía del aspirante
            </a>
  ...
  <section class="dudas">
    <div class="container">
      <div class="row justify-content-center mb-4">
        <div class="col-md-9">
          <h2>¿Tienes dudas para registrarte? Te ayudamos</h2>
        </div>
      </div>
